...
export default function ManagerOverview() {
  ...
  // Chart data - separate arrays for each chart to avoid key conflicts
  const revenueData = [
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <AreaChart data={revenueData} id="manager-revenue-chart">
                <defs>
                  <linearGradient id="managerRevenueGradientUnique2024" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area
                  ...
                  stroke="#8b5cf6"
                  fillOpacity={1}
                  fill="url(#managerRevenueGradientUnique2024)"
                  name="Doanh thu (đ)"
                />
              </AreaChart>
            </ResponsiveContainer>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={userGrowthData} id="manager-user-growth-chart">
                <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
                <XAxis dataKey="month" stroke="#888" />
                <YAxis stroke="#888" />
                <Tooltip />
                <Bar dataKey="users" fill="#3b82f6" name="Người dùng" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <RePieChart id="manager-usertype-pie">
                <Pie
                  data={userTypeData}
                  cx="50%"
                  cy="50%"
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <RePieChart id="manager-report-status-pie">
                <Pie
